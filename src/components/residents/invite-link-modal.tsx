...
import { createResidentInvite } from "@/api/post-resident-invite";
...
export function ResidentInviteLinkModal({
  ...
  const { mutateAsync, isPending } = useMutation({
    mutationFn: createResidentInvite,
  });
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Compartilhe o link para que o morador faça o próprio cadastro.
          </DialogDescription>
        </DialogHeader>
